...
function setupExpressApp(app) {
	...
	// Keep session support for backward compatibility and migration
	app.use(
		session({
	...
	// Add JWT authentication middleware with session fallback
	const migrationHelper = require("./middleware/migration-helper");
	app.use(migrationHelper.hybridAuth);
